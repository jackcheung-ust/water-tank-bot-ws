...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("water_bot_control"), "urdf", "diffbot.urdf.xacro"]
            ),
            " ",
            "use_mock_hardware:=",
            use_mock_hardware,
    ...
    robot_controllers = PathJoinSubstitution(
        [
            FindPackageShare("water_bot_control"),
            "config",
            "diffbot_controllers.yaml",
        ]
    )
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("water_bot_description"), "diffbot/rviz", "diffbot.rviz"]
    )
